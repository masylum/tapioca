    ...
    it "compile RBIs with location from gem source" do
      ...
      output = template(<<~RBI)
        ...
        class Baz
          ...
          # source://sorbet-runtime//lib/types/private/abstract/declare.rb#37
        <% if ruby_version(">= 3.1") %>
          def initialize(*args, **_arg1, &blk); end
        <% else %>
          def initialize(*args, &blk); end
        ...
        class Option
          ...
          # source://mutex_m//mutex_m.rb##{mutex.instance_method(:lock).source_location&.last}
          def lock; end

          # source://mutex_m//mutex_m.rb##{mutex.instance_method(:locked?).source_location&.last}
          def locked?; end

          # source://mutex_m//mutex_m.rb##{mutex.instance_method(:synchronize).source_location&.last}
          def synchronize(&block); end

          # source://mutex_m//mutex_m.rb##{mutex.instance_method(:try_lock).source_location&.last}
          def try_lock; end

          # source://mutex_m//mutex_m.rb##{mutex.instance_method(:unlock).source_location&.last}
          def unlock; end
        end
        ...
        class Quux < ::T::Struct
          class << self
            # source://sorbet-runtime//lib/types/struct.rb#13
            def inherited(s); end
          end
        end
