...
# source://webmock//lib/webmock/http_lib_adapters/net_http.rb#269
class Net::WebMockNetBufferedIO < ::Net::BufferedIO
  ...
  #
  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#294
  def rbuf_fill; end
end
...
class StubSocket
  ...
  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#254
  def io; end
...
class StubSocket::StubIO
  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#263
  def cipher; end

  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#260
  def peer_cert; end

  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#261
  def peeraddr; end

  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#259
  def setsockopt(*args); end

  # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#262
  def ssl_version; end
end
...
# source://webmock//lib/webmock/http_lib_adapters/net_http.rb#316
module WebMock::NetHTTPUtility
  class << self
    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#375
    def check_right_http_connection; end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#347
    def get_uri(net_http, path = T.unsafe(nil)); end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#379
    def puts_warning_for_right_http_if_needed; end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#318
    def request_signature_from_request(net_http, request, body = T.unsafe(nil)); end

    # source://webmock//lib/webmock/http_lib_adapters/net_http.rb#356
