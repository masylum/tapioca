...
# source://digest//lib/digest/version.rb#3
module Digest
  class << self
    # source://digest//lib/digest.rb#22
    def const_missing(name); end
  end
end

# source://digest//lib/digest.rb#41
class Digest::Class
  ...
  class << self
    ...
    # feeds.
    #
    # source://digest//lib/digest.rb#55
    ...
    #
    # source://digest//lib/digest.rb#48
    def file(name, *args); end
  end
end

# source://digest//lib/digest.rb#60
module Digest::Instance
  ...
  #
  # source://digest//lib/digest.rb#82
  def base64digest(str = T.unsafe(nil)); end

  # Returns the resulting hash value and resets the digest to the
  # initial state.
  #
  # source://digest//lib/digest.rb#88
  def base64digest!; end

  # Updates the digest with the contents of a given file _name_ and
  # returns self.
  #
  # source://digest//lib/digest.rb#63
  def file(name); end
end
...
#
# source://digest//lib/digest/sha2.rb#60
class Digest::SHA2 < ::Digest::Class
  ...
  #
  # source://digest//lib/digest/sha2.rb#61
  ...
  #
  # source://digest//lib/digest/sha2.rb#89
  def <<(str); end
  ...
  #   # => 1024
  #
  # source://digest//lib/digest/sha2.rb#112
  ...
  # (256 bits) in size.
  #
  # source://digest//lib/digest/sha2.rb#130
  def digest_length; end

  # source://digest//lib/digest/sha2.rb#138
  def inspect; end
  ...
  #
  # source://digest//lib/digest/sha2.rb#79
  def reset; end
  ...
  # source://digest//lib/digest/sha2.rb#95
  def finish; end

  # source://digest//lib/digest/sha2.rb#134
  def initialize_copy(other); end
end

# source://digest//lib/digest/version.rb#4
...
class Object < ::BasicObject
  ...
  # source://digest//lib/digest.rb#110
  def Digest(name); end
end
