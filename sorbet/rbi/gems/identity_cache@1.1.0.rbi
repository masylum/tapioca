...
# source://identity_cache//lib/identity_cache/version.rb#2
module IdentityCache
  ...
  # source://identity_cache//lib/identity_cache.rb#68
  def cache_namespace; end

  # source://identity_cache//lib/identity_cache.rb#68
  def cache_namespace=(val); end

  # source://identity_cache//lib/identity_cache.rb#74
  ...
  class << self
    ...
    #
    # source://identity_cache//lib/identity_cache.rb#83
    def append_features(base); end

    # source://identity_cache//lib/identity_cache.rb#102
    def cache; end
    ...
    #
    # source://identity_cache//lib/identity_cache.rb#94
    ...
    # source://identity_cache//lib/identity_cache.rb#195
    def eager_load!; end
    ...
    # source://identity_cache//lib/identity_cache.rb#106
    def logger; end
    ...
    #
    # source://identity_cache//lib/identity_cache.rb#81
    def logger=(_arg0); end

    # source://identity_cache//lib/identity_cache.rb#153
    def map_cached_nil_for(value); end

    # Returns the value of attribute readonly.
    #
    # source://identity_cache//lib/identity_cache.rb#80
    def readonly; end
    ...
    # @return [Boolean]
    #
    # source://identity_cache//lib/identity_cache.rb#110
    def should_fill_cache?; end

    # @return [Boolean]
    #
    # source://identity_cache//lib/identity_cache.rb#114
    def should_use_cache?; end

    # source://identity_cache//lib/identity_cache.rb#157
    def unmap_cached_nil_for(value); end

    # source://identity_cache//lib/identity_cache.rb#187
    def with_fetch_read_only_records(value = T.unsafe(nil)); end

    private

    # source://identity_cache//lib/identity_cache.rb#201
...
# source://identity_cache//lib/identity_cache.rb#56
class IdentityCache::AlreadyIncludedError < ::StandardError; end

# source://identity_cache//lib/identity_cache.rb#58
...
# source://identity_cache//lib/identity_cache/belongs_to_caching.rb#3
...
# source://identity_cache//lib/identity_cache/belongs_to_caching.rb#11
...
# source://identity_cache//lib/identity_cache.rb#51
...
# source://identity_cache//lib/identity_cache/cache_fetcher.rb#3
class IdentityCache::CacheFetcher
  ...
  #
  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#4
  ...
  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#18
  def clear; end

  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#14
  def delete(key); end

  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#28
  def fetch(key); end

  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#22
  def fetch_multi(keys, &block); end

  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#10
  def write(key, value); end

  private

  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#84
  def add(key, value); end

  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#78
  def add_multi(keys); end

  # source://identity_cache//lib/identity_cache/cache_fetcher.rb#50
  def cas_multi(keys); end
end

# source://identity_cache//lib/identity_cache/cache_hash.rb#22
module IdentityCache::CacheHash
  # source://identity_cache//lib/identity_cache/cache_hash.rb#25
  def memcache_hash(key); end
end

# source://identity_cache//lib/identity_cache/cache_invalidation.rb#3
module IdentityCache::CacheInvalidation
  # source://identity_cache//lib/identity_cache/cache_invalidation.rb#6
  def reload(*_arg0); end

  private

  # source://identity_cache//lib/identity_cache/cache_invalidation.rb#13
...
# source://identity_cache//lib/identity_cache/cache_key_generation.rb#3
module IdentityCache::CacheKeyGeneration
  ...
  class << self
    # source://identity_cache//lib/identity_cache/cache_key_generation.rb#28
    def denormalized_schema_hash(klass); end

    # source://identity_cache//lib/identity_cache/cache_key_generation.rb#11
    def denormalized_schema_string(klass); end

    # source://identity_cache//lib/identity_cache/cache_key_generation.rb#7
    def schema_to_string(columns); end
  end
end

# source://identity_cache//lib/identity_cache/cache_key_generation.rb#33
module IdentityCache::CacheKeyGeneration::ClassMethods
  # source://identity_cache//lib/identity_cache/cache_key_generation.rb#34
  def rails_cache_key_namespace; end
end

# source://identity_cache//lib/identity_cache/cache_key_generation.rb#5
...
# source://identity_cache//lib/identity_cache/cached.rb#3
module IdentityCache::Cached; end

# source://identity_cache//lib/identity_cache/cached/association.rb#4
class IdentityCache::Cached::Association
  ...
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#7
  def initialize(name, reflection:); end

  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#16
  def build; end

  # Returns the value of attribute cached_accessor_name.
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#14
  def cached_accessor_name; end

  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#28
  def clear(_record); end

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#40
  def embedded?; end

  # @raise [NotImplementedError]
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#44
  def embedded_by_reference?; end

  # @raise [NotImplementedError]
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#48
  def embedded_recursively?; end

  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#32
  def fetch(_records); end

  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#36
  def fetch_async(_load_strategy, _records); end

  # source://identity_cache//lib/identity_cache/cached/association.rb#52
  ...
  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#20
  ...
  # source://identity_cache//lib/identity_cache/cached/association.rb#59
  def validate; end

  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/association.rb#24
...
class IdentityCache::Cached::Attribute
  ...
  # source://identity_cache//lib/identity_cache/cached/attribute.rb#50
  ...
  # source://identity_cache//lib/identity_cache/cached/attribute.rb#55
  ...
  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/attribute.rb#80
  ...
  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/attribute.rb#65
  ...
  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/attribute.rb#75
  def load_from_db_where_conditions(_index_key_or_keys); end

  # source://identity_cache//lib/identity_cache/cached/attribute.rb#98
  ...
  # @raise [NotImplementedError]
  #
  # source://identity_cache//lib/identity_cache/cached/attribute.rb#70
...
# source://identity_cache//lib/identity_cache/cached/belongs_to.rb#4
class IdentityCache::Cached::BelongsTo < ::IdentityCache::Cached::Association
  # source://identity_cache//lib/identity_cache/cached/belongs_to.rb#7
  def build; end

  # source://identity_cache//lib/identity_cache/cached/belongs_to.rb#24
  def clear(record); end

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/belongs_to.rb#95
  def embedded_by_reference?; end

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/belongs_to.rb#91
  def embedded_recursively?; end

  # source://identity_cache//lib/identity_cache/cached/belongs_to.rb#34
  def fetch(records); end

  # source://identity_cache//lib/identity_cache/cached/belongs_to.rb#38
  ...
  # source://identity_cache//lib/identity_cache/cached/belongs_to.rb#30
  def write(owner_record, associated_record); end
end

# source://identity_cache//lib/identity_cache/cached/embedded_fetching.rb#4
module IdentityCache::Cached::EmbeddedFetching
  private

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/embedded_fetching.rb#34
  def embedded_fetched?(records); end

  # source://identity_cache//lib/identity_cache/cached/embedded_fetching.rb#7
  def fetch_embedded(records); end

  # source://identity_cache//lib/identity_cache/cached/embedded_fetching.rb#11
...
class IdentityCache::Cached::PrimaryIndex
  ...
  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#72
  ...
  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#50
  def cache_key(id); end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#45
  def expire(id); end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#12
  def fetch(id); end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#33
  def fetch_multi(ids); end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#60
  def load_multi_from_db(ids); end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#54
  ...
  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#86
  def build_query(id_or_ids); end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#90
  def cache_key_prefix; end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#78
  def cast_id(id); end

  # source://identity_cache//lib/identity_cache/cached/primary_index.rb#82
  def id_column; end
end

# source://identity_cache//lib/identity_cache/cached/recursive/association.rb#4
...
class IdentityCache::Cached::Recursive::Association < ::IdentityCache::Cached::Association
  ...
  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#13
  def build; end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#52
  def clear(record); end

  # Returns the value of attribute dehydrated_variable_name.
  #
  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#11
  def dehydrated_variable_name; end

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#68
  def embedded_by_reference?; end

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#72
  def embedded_recursively?; end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#58
  def fetch(records); end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#62
  def fetch_async(load_strategy, records); end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#24
  def read(record); end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#47
  def set_with_inverse(record, association_target); end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#43
  ...
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#102
  def embedded_fetched?(records); end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#93
  def hydrate_association_target(associated_class, dehydrated_value); end

  # source://identity_cache//lib/identity_cache/cached/recursive/association.rb#78
  def set_inverse(record, association_target); end
end

# source://identity_cache//lib/identity_cache/cached/recursive/has_many.rb#5
class IdentityCache::Cached::Recursive::HasMany < ::IdentityCache::Cached::Recursive::Association; end

# source://identity_cache//lib/identity_cache/cached/recursive/has_one.rb#5
class IdentityCache::Cached::Recursive::HasOne < ::IdentityCache::Cached::Recursive::Association; end

# source://identity_cache//lib/identity_cache/cached/reference/association.rb#4
...
class IdentityCache::Cached::Reference::Association < ::IdentityCache::Cached::Association
  ...
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/reference/association.rb#10
  def embedded_recursively?; end
end

# source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#5
class IdentityCache::Cached::Reference::HasMany < ::IdentityCache::Cached::Reference::Association
  ...
  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#14
  def build; end

  # Returns the value of attribute cached_ids_name.
  #
  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#12
  def cached_ids_name; end

  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#43
  def clear(record); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#51
  def fetch(records); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#55
  def fetch_async(load_strategy, records); end
  ...
  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#35
  def read(record); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#39
  ...
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#86
  def embedded_fetched?(records); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#99
  def ids_cached_reader_name; end

  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#95
  def ids_name; end

  # source://identity_cache//lib/identity_cache/cached/reference/has_many.rb#91
  def singular_name; end
end

# source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#5
class IdentityCache::Cached::Reference::HasOne < ::IdentityCache::Cached::Reference::Association
  ...
  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#14
  def build; end

  # Returns the value of attribute cached_id_name.
  #
  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#12
  def cached_id_name; end

  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#44
  def clear(record); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#52
  def fetch(records); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#56
  def fetch_async(load_strategy, records); end
  ...
  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#36
  def read(record); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#40
  ...
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#85
  def embedded_fetched?(records); end

  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#94
  def id_cached_reader_name; end

  # source://identity_cache//lib/identity_cache/cached/reference/has_one.rb#90
  def id_name; end
end

# source://identity_cache//lib/identity_cache/configuration_dsl.rb#3
...
# source://identity_cache//lib/identity_cache/configuration_dsl.rb#16
module IdentityCache::ConfigurationDSL::ClassMethods
  ...
  #
  # source://identity_cache//lib/identity_cache/configuration_dsl.rb#118
  ...
  #   records.
  #
  # source://identity_cache//lib/identity_cache/configuration_dsl.rb#44
  ...
  #
  # source://identity_cache//lib/identity_cache/configuration_dsl.rb#82
  def cache_has_one(association, embed:); end

  private

  # source://identity_cache//lib/identity_cache/configuration_dsl.rb#124
  def cache_attribute_by_alias(attribute_or_proc, alias_name:, by:, unique:); end

  # source://identity_cache//lib/identity_cache/configuration_dsl.rb#143
  def check_association_for_caching(association); end

  # source://identity_cache//lib/identity_cache/configuration_dsl.rb#134
...
# source://identity_cache//lib/identity_cache.rb#66
class IdentityCache::DerivedModelError < ::StandardError; end

# source://identity_cache//lib/identity_cache/encoder.rb#3
module IdentityCache::Encoder
  class << self
    # source://identity_cache//lib/identity_cache/encoder.rb#16
    def decode(coder, klass); end

    # source://identity_cache//lib/identity_cache/encoder.rb#8
    def encode(record); end

    private

    # source://identity_cache//lib/identity_cache/encoder.rb#26
    def coder_from_record(record, klass); end

    # source://identity_cache//lib/identity_cache/encoder.rb#57
    def embedded_coder(record, _association, cached_association); end

    # source://identity_cache//lib/identity_cache/encoder.rb#69
...
# source://identity_cache//lib/identity_cache/expiry_hook.rb#3
class IdentityCache::ExpiryHook
  ...
  # source://identity_cache//lib/identity_cache/expiry_hook.rb#8
  def install; end
  ...
  #
  # source://identity_cache//lib/identity_cache/expiry_hook.rb#16
  def cached_association; end

  # source://identity_cache//lib/identity_cache/expiry_hook.rb#30
  def child_class; end

  # source://identity_cache//lib/identity_cache/expiry_hook.rb#22
  def inverse_name; end

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/expiry_hook.rb#18
  def only_on_foreign_key_change?; end

  # source://identity_cache//lib/identity_cache/expiry_hook.rb#26
  def parent_class; end
end

# source://identity_cache//lib/identity_cache/fallback_fetcher.rb#3
class IdentityCache::FallbackFetcher
  # @return [FallbackFetcher] a new instance of FallbackFetcher
  #
  # source://identity_cache//lib/identity_cache/fallback_fetcher.rb#6
  def initialize(cache_backend); end
  ...
  # source://identity_cache//lib/identity_cache/fallback_fetcher.rb#18
  def clear; end

  # source://identity_cache//lib/identity_cache/fallback_fetcher.rb#14
  def delete(key); end

  # source://identity_cache//lib/identity_cache/fallback_fetcher.rb#35
  def fetch(key); end

  # source://identity_cache//lib/identity_cache/fallback_fetcher.rb#22
  def fetch_multi(keys); end

  # source://identity_cache//lib/identity_cache/fallback_fetcher.rb#10
  def write(key, value); end
end

# source://identity_cache//lib/identity_cache.rb#60
...
# source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#6
class IdentityCache::MemoizedCacheProxy
  # @return [MemoizedCacheProxy] a new instance of MemoizedCacheProxy
  #
  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#9
  def initialize(cache_adaptor = T.unsafe(nil)); end

  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#14
  def cache_backend=(cache_adaptor); end
  ...
  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#134
  def clear; end

  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#59
  def delete(key); end

  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#72
  def fetch(key); end

  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#103
  def fetch_multi(*keys); end

  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#39
  def memoized_key_values; end

  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#43
  def with_memoization; end

  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#51
  def write(key, value); end
  ...
  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#153
  ...
  # source://identity_cache//lib/identity_cache/memoized_cache_proxy.rb#146
...
# source://identity_cache//lib/identity_cache/parent_model_expiration.rb#3
module IdentityCache::ParentModelExpiration
  ...
  # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#51
  ...
  # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#43
  def expire_parent_caches; end

  # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#64
  def parents_to_expire_on_changes(parents_to_expire, association_name, cached_associations); end

  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#98
  def should_expire_identity_cache_parent?(foreign_key, only_on_foreign_key_change); end

  class << self
    # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#8
    def add_parent_expiry_hook(cached_association); end

    # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#13
    def install_all_pending_parent_expiry_hooks; end

    # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#23
    def install_pending_parent_expiry_hooks(model); end

    private

    # source://identity_cache//lib/identity_cache/parent_model_expiration.rb#33
    def lazy_hooks; end
  end
...
# source://identity_cache//lib/identity_cache/query_api.rb#3
module IdentityCache::QueryAPI
  ...
  #
  # source://identity_cache//lib/identity_cache/query_api.rb#163
  def _run_commit_callbacks; end

  # Invalidate the cache data associated with the record.
  #
  # source://identity_cache//lib/identity_cache/query_api.rb#172
  def expire_cache; end

  # @api private
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/query_api.rb#178
...
# source://identity_cache//lib/identity_cache/query_api.rb#6
module IdentityCache::QueryAPI::ClassMethods
  # @api private
  #
  # source://identity_cache//lib/identity_cache/query_api.rb#18
  def all_cached_associations; end

  # @api private
  #
  # source://identity_cache//lib/identity_cache/query_api.rb#13
  def cached_association(name); end

  # Prefetches cached associations on a collection of records
  #
  # source://identity_cache//lib/identity_cache/query_api.rb#8
  def prefetch_associations(includes, records); end

  private

  # source://identity_cache//lib/identity_cache/query_api.rb#134
  def cache_fetch_includes; end

  # source://identity_cache//lib/identity_cache/query_api.rb#31
  def check_association_scope(association_name); end

  # source://identity_cache//lib/identity_cache/query_api.rb#117
  def each_id_embedded_association; end

  # source://identity_cache//lib/identity_cache/query_api.rb#130
  def embedded_associations; end

  # source://identity_cache//lib/identity_cache/query_api.rb#42
  def preload_id_embedded_association(records, cached_association); end

  # source://identity_cache//lib/identity_cache/query_api.rb#24
  def raise_if_scoped; end

  # source://identity_cache//lib/identity_cache/query_api.rb#109
  def readonly_copy(record_or_records); end

  # source://identity_cache//lib/identity_cache/query_api.rb#103
  def readonly_record_copy(record); end

  # source://identity_cache//lib/identity_cache/query_api.rb#126
  def recursively_embedded_associations; end

  # source://identity_cache//lib/identity_cache/query_api.rb#68
  def setup_embedded_associations_on_miss(records, readonly: T.unsafe(nil)); end
end

# source://identity_cache//lib/identity_cache/railtie.rb#3
...
# source://identity_cache//lib/identity_cache/should_use_cache.rb#3
...
# source://identity_cache//lib/identity_cache/should_use_cache.rb#6
...
# source://identity_cache//lib/identity_cache.rb#64
class IdentityCache::UnsupportedAssociationError < ::StandardError; end

# source://identity_cache//lib/identity_cache.rb#62
...
# source://identity_cache//lib/identity_cache/with_primary_index.rb#3
module IdentityCache::WithPrimaryIndex
  ...
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#8
  def expire_cache; end

  # @api private
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#14
  def expire_primary_index; end

  # @api private
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#19
...
# source://identity_cache//lib/identity_cache/with_primary_index.rb#23
module IdentityCache::WithPrimaryIndex::ClassMethods
  ...
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#55
  ...
  # @return [Boolean]
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#96
  ...
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#131
  ...
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#113
  def fetch(id, includes: T.unsafe(nil)); end

  # Default fetcher added to the model on inclusion, it behaves like
  # ActiveRecord::Base.where(id: id).first
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#102
  def fetch_by_id(id, includes: T.unsafe(nil)); end

  # Default fetcher added to the model on inclusion, if behaves like
  # ActiveRecord::Base.find_all_by_id
  #
  # source://identity_cache//lib/identity_cache/with_primary_index.rb#121
  def fetch_multi(*ids, includes: T.unsafe(nil)); end

  # source://identity_cache//lib/identity_cache/with_primary_index.rb#29
  def primary_cache_index_enabled; end
end

# source://identity_cache//lib/identity_cache/without_primary_index.rb#3
module IdentityCache::WithoutPrimaryIndex
  ...
  class << self
    # @raise [AlreadyIncludedError]
    #
    # source://identity_cache//lib/identity_cache/without_primary_index.rb#15
    def append_features(base); end
  end
...
# source://identity_cache//lib/identity_cache/without_primary_index.rb#25
module IdentityCache::WithoutPrimaryIndex::ClassMethods
  # source://identity_cache//lib/identity_cache/without_primary_index.rb#26
  def primary_cache_index_enabled; end
end
