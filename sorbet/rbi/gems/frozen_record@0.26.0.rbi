...
module FrozenRecord::Backends::Yaml
  ...
  # source://frozen_record//lib/frozen_record/backends/yaml.rb#74
  def load_file(path); end

  # source://frozen_record//lib/frozen_record/backends/yaml.rb#78
...
class FrozenRecord::Base
  ...
  #
  # source://frozen_record//lib/frozen_record/base.rb#237
  def initialize(attrs = T.unsafe(nil)); end

  # source://frozen_record//lib/frozen_record/base.rb#254
  def ==(other); end

  # source://frozen_record//lib/frozen_record/base.rb#249
  def [](attr); end
  ...
  # source://frozen_record//lib/frozen_record/base.rb#245
  def id; end
  ...
  # @return [Boolean]
  #
  # source://frozen_record//lib/frozen_record/base.rb#258
  def persisted?; end
  ...
  class << self
    ...
    # source://frozen_record//lib/frozen_record/base.rb#153
    def eager_load!; end
    ...
    # source://frozen_record//lib/frozen_record/base.rb#131
    ...
    # @return [Boolean]
    #
    # source://frozen_record//lib/frozen_record/base.rb#146
    ...
    # source://frozen_record//lib/frozen_record/base.rb#220
...
class FrozenRecord::Scope
  ...
  # @return [Boolean]
  #
  # source://frozen_record//lib/frozen_record/scope.rb#252
  ...
  # source://frozen_record//lib/frozen_record/scope.rb#231
  def compare(record_a, record_b); end

  # source://frozen_record//lib/frozen_record/scope.rb#273
  def limit!(amount); end
  ...
  # source://frozen_record//lib/frozen_record/scope.rb#178
  def select_records(records); end

  # source://frozen_record//lib/frozen_record/scope.rb#223
  def slice_records(records); end

  # source://frozen_record//lib/frozen_record/scope.rb#215
  def sort_records(records); end

  # source://frozen_record//lib/frozen_record/scope.rb#157
  def spawn; end

  # source://frozen_record//lib/frozen_record/scope.rb#256
...
class FrozenRecord::Scope::CoverMatcher < ::FrozenRecord::Scope::Matcher
  ...
  # @return [Boolean]
  #
  # source://frozen_record//lib/frozen_record/scope.rb#334
  def ranged?; end
end
...
class FrozenRecord::Scope::IncludeMatcher < ::FrozenRecord::Scope::Matcher
  ...
  # @return [Boolean]
  #
  # source://frozen_record//lib/frozen_record/scope.rb#324
  def ranged?; end
end

# source://frozen_record//lib/frozen_record/scope.rb#285
class FrozenRecord::Scope::Matcher
  # @return [Matcher] a new instance of Matcher
  #
  # source://frozen_record//lib/frozen_record/scope.rb#305
  def initialize(value); end

  # source://frozen_record//lib/frozen_record/scope.rb#317
  def ==(other); end

  # source://frozen_record//lib/frozen_record/scope.rb#317
  def eql?(other); end

  # source://frozen_record//lib/frozen_record/scope.rb#301
  def hash; end
  ...
  #
  # source://frozen_record//lib/frozen_record/scope.rb#299
  def value; end

  class << self
    # source://frozen_record//lib/frozen_record/scope.rb#287
    def for(value); end
  end
end
