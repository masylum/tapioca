...
# source://activestorage//app/jobs/active_storage/analyze_job.rb#4
class ActiveStorage::AnalyzeJob < ::ActiveStorage::BaseJob
  # source://activestorage//app/jobs/active_storage/analyze_job.rb#10
...
class ActiveStorage::Analyzer::ImageAnalyzer::ImageMagick < ::ActiveStorage::Analyzer::ImageAnalyzer
  ...
  # source://activestorage//lib/active_storage/analyzer/image_analyzer/image_magick.rb#35
...
class ActiveStorage::Analyzer::ImageAnalyzer::Vips < ::ActiveStorage::Analyzer::ImageAnalyzer
  ...
  # source://activestorage//lib/active_storage/analyzer/image_analyzer/vips.rb#36
  def rotated_image?(image); end
...
# source://activestorage//lib/active_storage/analyzer/image_analyzer/vips.rb#35
...
# source://activestorage//app/models/active_storage/attachment.rb#18
class ActiveStorage::Attachment < ::ActiveStorage::Record
  ...
  # source://activestorage//app/models/active_storage/attachment.rb#33
  def purge; end

  # source://activestorage//app/models/active_storage/attachment.rb#42
  def purge_later; end

  # source://activestorage//app/models/active_storage/attachment.rb#25
  def signed_id(*_arg0, &_arg1); end

  def validate_associated_records_for_blob(*args); end

  # source://activestorage//app/models/active_storage/attachment.rb#56
  def variant(transformations); end

  private

  # source://activestorage//app/models/active_storage/attachment.rb#70
  def analyze_blob_later; end

  # source://activestorage//app/models/active_storage/attachment.rb#82
  def dependent; end

  # source://activestorage//app/models/active_storage/attachment.rb#74
  def mirror_blob_later; end

  # source://activestorage//app/models/active_storage/attachment.rb#78
  def purge_dependent_blob_later; end

  def respond_to_missing?(name, include_private = T.unsafe(nil)); end

  # source://activestorage//app/models/active_storage/attachment.rb#86
  def variants; end
...
# source://activestorage//app/models/active_storage/attachment.rb#0
...
# source://activestorage//app/controllers/active_storage/base_controller.rb#4
...
# source://activestorage//app/jobs/active_storage/base_job.rb#3
class ActiveStorage::BaseJob < ::ActiveJob::Base; end

# source://activestorage//app/models/active_storage/blob.rb#32
...
# source://activestorage//app/models/active_storage/blob/analyzable.rb#5
module ActiveStorage::Blob::Analyzable
  # source://activestorage//app/models/active_storage/blob/analyzable.rb#28
  def analyze; end

  # source://activestorage//app/models/active_storage/blob/analyzable.rb#36
  def analyze_later; end

  # source://activestorage//app/models/active_storage/blob/analyzable.rb#45
  def analyzed?; end

  private

  # source://activestorage//app/models/active_storage/blob/analyzable.rb#54
  def analyzer; end

  # source://activestorage//app/models/active_storage/blob/analyzable.rb#58
  def analyzer_class; end

  # source://activestorage//app/models/active_storage/blob/analyzable.rb#50
  def extract_metadata_via_analyzer; end
end

# source://activestorage//app/models/active_storage/blob.rb#0
module ActiveStorage::Blob::GeneratedAssociationMethods; end

# source://activestorage//app/models/active_storage/blob.rb#0
module ActiveStorage::Blob::GeneratedAttributeMethods; end

# source://activestorage//app/models/active_storage/blob/identifiable.rb#3
module ActiveStorage::Blob::Identifiable
  # source://activestorage//app/models/active_storage/blob/identifiable.rb#16
  def identified?; end

  # source://activestorage//app/models/active_storage/blob/identifiable.rb#4
  def identify; end

  # source://activestorage//app/models/active_storage/blob/identifiable.rb#9
  def identify_without_saving; end

  private

  # source://activestorage//app/models/active_storage/blob/identifiable.rb#25
  def download_identifiable_chunk; end

  # source://activestorage//app/models/active_storage/blob/identifiable.rb#21
  def identify_content_type; end
end

# source://activestorage//app/models/active_storage/blob/representable.rb#5
module ActiveStorage::Blob::Representable
  extend ::ActiveSupport::Concern

  # source://activestorage//app/models/active_storage/blob/representable.rb#63
  def preview(transformations); end

  # source://activestorage//app/models/active_storage/blob/representable.rb#72
  def previewable?; end

  # source://activestorage//app/models/active_storage/blob/representable.rb#97
  def representable?; end

  # source://activestorage//app/models/active_storage/blob/representable.rb#85
  def representation(transformations); end

  # source://activestorage//app/models/active_storage/blob/representable.rb#44
  def variable?; end

  # source://activestorage//app/models/active_storage/blob/representable.rb#34
  def variant(transformations); end

  private

  # source://activestorage//app/models/active_storage/blob/representable.rb#106
  def default_variant_format; end

  # source://activestorage//app/models/active_storage/blob/representable.rb#102
  def default_variant_transformations; end

  # source://activestorage//app/models/active_storage/blob/representable.rb#114
  def format; end

  # source://activestorage//app/models/active_storage/blob/representable.rb#122
  def variant_class; end
end

# source://activestorage//app/models/active_storage/current.rb#3
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  # source://activestorage//app/models/active_storage/current.rb#11
  def host; end

  # source://activestorage//app/models/active_storage/current.rb#6
  def host=(host); end
...
# source://activestorage//app/controllers/active_storage/direct_uploads_controller.rb#6
class ActiveStorage::DirectUploadsController < ::ActiveStorage::BaseController
  # source://activestorage//app/controllers/active_storage/direct_uploads_controller.rb#7
  def create; end
  ...
  # source://activestorage//app/controllers/active_storage/direct_uploads_controller.rb#13
  def blob_args; end

  # source://activestorage//app/controllers/active_storage/direct_uploads_controller.rb#17
...
# source://activestorage//app/controllers/active_storage/disk_controller.rb#7
class ActiveStorage::DiskController < ::ActiveStorage::BaseController
  include ::ActiveStorage::FileServer

  # source://activestorage//app/controllers/active_storage/disk_controller.rb#12
  def show; end

  # source://activestorage//app/controllers/active_storage/disk_controller.rb#22
  def update; end
  ...
  # source://activestorage//app/controllers/active_storage/disk_controller.rb#52
  def acceptable_content?(token); end

  # source://activestorage//app/controllers/active_storage/disk_controller.rb#44
  def decode_verified_key; end

  # source://activestorage//app/controllers/active_storage/disk_controller.rb#48
  def decode_verified_token; end

  # source://activestorage//app/controllers/active_storage/disk_controller.rb#38
...
# source://activestorage//app/controllers/concerns/active_storage/file_server.rb#3
module ActiveStorage::FileServer
  private

  # source://activestorage//app/controllers/concerns/active_storage/file_server.rb#5
  def serve_file(path, content_type:, disposition:); end
end

# source://activestorage//app/models/active_storage/filename.rb#5
class ActiveStorage::Filename
  include ::Comparable

  # source://activestorage//app/models/active_storage/filename.rb#16
  def initialize(filename); end

  # source://activestorage//app/models/active_storage/filename.rb#74
  def <=>(other); end

  # source://activestorage//app/models/active_storage/filename.rb#66
  def as_json(*_arg0); end

  # source://activestorage//app/models/active_storage/filename.rb#25
  def base; end

  # source://activestorage//app/models/active_storage/filename.rb#45
  def extension; end

  # source://activestorage//app/models/active_storage/filename.rb#35
  def extension_with_delimiter; end

  # source://activestorage//app/models/active_storage/filename.rb#45
  def extension_without_delimiter; end

  # source://activestorage//app/models/active_storage/filename.rb#57
  def sanitized; end

  # source://activestorage//app/models/active_storage/filename.rb#70
  def to_json; end

  # source://activestorage//app/models/active_storage/filename.rb#62
  def to_s; end

  class << self
    # source://activestorage//app/models/active_storage/filename.rb#11
...
# source://activestorage//app/jobs/active_storage/mirror_job.rb#6
class ActiveStorage::MirrorJob < ::ActiveStorage::BaseJob
  # source://activestorage//app/jobs/active_storage/mirror_job.rb#12
...
# source://activestorage//app/models/active_storage/preview.rb#31
class ActiveStorage::Preview
  # source://activestorage//app/models/active_storage/preview.rb#36
  def initialize(blob, variation_or_variation_key); end

  # source://activestorage//app/models/active_storage/preview.rb#34
  def blob; end

  # source://activestorage//app/models/active_storage/preview.rb#83
  def download(&block); end

  # source://activestorage//app/models/active_storage/preview.rb#52
  def image; end

  # source://activestorage//app/models/active_storage/preview.rb#70
  def key; end

  # source://activestorage//app/models/active_storage/preview.rb#46
  def processed; end

  # source://activestorage//app/models/active_storage/preview.rb#61
  def url(**options); end
  ...
  # source://activestorage//app/models/active_storage/preview.rb#109
  def previewer; end

  # source://activestorage//app/models/active_storage/preview.rb#113
  def previewer_class; end

  # source://activestorage//app/models/active_storage/preview.rb#96
  def process; end

  # source://activestorage//app/models/active_storage/preview.rb#92
  def processed?; end

  # source://activestorage//app/models/active_storage/preview.rb#104
  def variant; end
end

# source://activestorage//app/models/active_storage/preview.rb#32
...
# source://activestorage//app/jobs/active_storage/purge_job.rb#4
class ActiveStorage::PurgeJob < ::ActiveStorage::BaseJob
  # source://activestorage//app/jobs/active_storage/purge_job.rb#10
  def perform(blob); end
...
# source://activestorage//app/models/active_storage/record.rb#3
...
# source://activestorage//app/models/active_storage/record.rb#0
...
# source://activestorage//app/controllers/concerns/active_storage/set_blob.rb#3
module ActiveStorage::SetBlob
  extend ::ActiveSupport::Concern

  private

  # source://activestorage//app/controllers/concerns/active_storage/set_blob.rb#17
  def blob_scope; end

  # source://activestorage//app/controllers/concerns/active_storage/set_blob.rb#11
  def set_blob; end
end

# source://activestorage//app/controllers/concerns/active_storage/set_current.rb#7
module ActiveStorage::SetCurrent
  extend ::ActiveSupport::Concern
end

# source://activestorage//app/controllers/concerns/active_storage/streaming.rb#5
module ActiveStorage::Streaming
  ...
  # source://activestorage//app/controllers/concerns/active_storage/streaming.rb#13
  def send_blob_byte_range_data(blob, range_header, disposition: T.unsafe(nil)); end

  # source://activestorage//app/controllers/concerns/active_storage/streaming.rb#55
  def send_blob_stream(blob, disposition: T.unsafe(nil)); end
end

# source://activestorage//app/controllers/concerns/active_storage/streaming.rb#6
...
# source://activestorage//app/models/active_storage/variant.rb#53
class ActiveStorage::Variant
  # source://activestorage//app/models/active_storage/variant.rb#58
  def initialize(blob, variation_or_variation_key); end

  # source://activestorage//app/models/active_storage/variant.rb#54
  def blob; end

  # source://activestorage//app/models/active_storage/variant.rb#56
  def content_type(*_arg0, &_arg1); end

  # source://activestorage//app/models/active_storage/variant.rb#56
  def content_type_for_serving(*_arg0, &_arg1); end

  # source://activestorage//app/models/active_storage/variant.rb#84
  def download(&block); end

  # source://activestorage//app/models/active_storage/variant.rb#88
  def filename; end

  # source://activestorage//app/models/active_storage/variant.rb#94
  def forced_disposition_for_serving; end

  # source://activestorage//app/models/active_storage/variant.rb#99
  def image; end

  # source://activestorage//app/models/active_storage/variant.rb#69
  def key; end

  # source://activestorage//app/models/active_storage/variant.rb#63
  def processed; end

  # source://activestorage//app/models/active_storage/variant.rb#55
  def service(*_arg0, &_arg1); end

  # source://activestorage//app/models/active_storage/variant.rb#78
  ...
  # source://activestorage//app/models/active_storage/variant.rb#108
  def process; end

  # source://activestorage//app/models/active_storage/variant.rb#104
  def processed?; end
end

# source://activestorage//app/models/active_storage/variant_record.rb#3
...
# source://activestorage//app/models/active_storage/variant_record.rb#0
...
# source://activestorage//app/models/active_storage/variant_with_record.rb#5
class ActiveStorage::VariantWithRecord
  # source://activestorage//app/models/active_storage/variant_with_record.rb#9
  def initialize(blob, variation); end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#6
  def blob; end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#30
  def download(*_arg0, &_arg1); end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#26
  def image; end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#30
  def key(*_arg0, &_arg1); end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#18
  def process; end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#13
  def processed; end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#22
  def processed?; end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#7
  def service(*_arg0, &_arg1); end
  ...
  # source://activestorage//app/models/active_storage/variant_with_record.rb#42
  def create_or_find_record(image:); end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#51
  def record; end

  # source://activestorage//app/models/active_storage/variant_with_record.rb#33
  def transform_blob; end
end

# source://activestorage//app/models/active_storage/variation.rb#14
class ActiveStorage::Variation
  # source://activestorage//app/models/active_storage/variation.rb#44
  def initialize(transformations); end

  # source://activestorage//app/models/active_storage/variation.rb#68
  def content_type; end

  # source://activestorage//app/models/active_storage/variation.rb#48
  def default_to(defaults); end

  # source://activestorage//app/models/active_storage/variation.rb#77
  def digest; end

  # source://activestorage//app/models/active_storage/variation.rb#60
  def format; end

  # source://activestorage//app/models/active_storage/variation.rb#73
  def key; end

  # source://activestorage//app/models/active_storage/variation.rb#54
  def transform(file, &block); end

  # source://activestorage//app/models/active_storage/variation.rb#15
  def transformations; end

  private

  # source://activestorage//app/models/active_storage/variation.rb#82
  def transformer; end

  class << self
    # source://activestorage//app/models/active_storage/variation.rb#33
    def decode(key); end

    # source://activestorage//app/models/active_storage/variation.rb#39
    def encode(transformations); end

    # source://activestorage//app/models/active_storage/variation.rb#21
